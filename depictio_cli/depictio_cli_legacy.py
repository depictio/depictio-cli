...
class TokenData(BaseModel):
    ...
    def validate_expire_datetime(cls, v):
        ...
        if not v:
            ...
            try:
                # Check if the string can be converted to a datetime object and if the expiration date is not reached
...
def validate_depictio_agent_config():
    depictio_agent_config = load_depictio_config("depictio-cli/depictio_agent_config.yaml")
