...
from depictio_cli.cli.utils.helpers import process_project_helper
from depictio_cli.logging import logger
from depictio_cli.cli.utils.rich_utils import rich_print_checked_statement, rich_print_command_usage, rich_print_section_separator
...
def scan(
    ...
    sync_files: bool = typer.Option(False, "--sync-files", help="Update files for the data collection"),
):
    """
    Scan files.
...
def process(
    ...
    overwrite: Optional[bool] = typer.Option(False, "--overwrite", help="Overwrite the workflow if it already exists"),
