...
from depictio_cli.cli.utils.rich_utils import rich_print_checked_statement, rich_print_json, rich_print_command_usage
...
def validate_project_config(
    ...
    if response["success"]:
        ...
        rich_print_checked_statement("Pipeline configuration invalid, use --verbose for more details.", "error")
...
def sync_project_config_to_server(
    CLI_config_path: Annotated[str, typer.Option("--CLI-config-path", help="Path to the configuration file")] = "~/.depictio/CLI.yaml",
    project_config_path: Annotated[str, typer.Option("--project-config-path", help="Path to the pipeline configuration file")] = "",
    update: Annotated[bool, typer.Option("--update", help="Update the project configuration on the server")] = False,
):
    """
    ...
    """
    CLI_config, validation_response = validate_project_config_and_check_S3_storage(CLI_config_path=CLI_config_path, project_config_path=project_config_path)
